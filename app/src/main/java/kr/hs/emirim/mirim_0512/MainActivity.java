package kr.hs.emirim.mirim_0512;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textResult = findViewById(R.id.text_resurt);
        Button btnplus = findViewById(R.id.btn_plus);
        Button btnMinus = findViewById(R.id.btn_minus);
        Button btnMulti = findViewById(R.id.btn_crose);
            ...
            btnNum[index].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(edit1.isFocused()){
                        ...
                        Toast.makeText(getApplicationContext(), "editText에 포커스가 없다", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
